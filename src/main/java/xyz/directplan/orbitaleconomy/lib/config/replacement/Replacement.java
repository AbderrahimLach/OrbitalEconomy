package xyz.directplan.orbitaleconomy.lib.config.replacement;

import xyz.directplan.orbitaleconomy.lib.config.replacement.characters.PercentReplacementChar;
